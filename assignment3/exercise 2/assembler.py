...
def main_for_tests(assembler_cls, input_path="-", output_path="-"):
    reader = open(input_path, "r") if input_path != "-" else sys.stdin
    writer = open(output_path, "w") if output_path != "-" else sys.stdout
